...
class ParentWindow(Frame):
    def __init__ (self, master):
        ...
        self.btnBrowse1 = tk.Button(self.master, text='Source File', width=12, height=1, command=fta.Browse1(self))
        self.btnBrowse1.grid(row=1, column=0, padx=(30,0), pady=(60,0), sticky=SE)
        self.btnBrowse2 = tk.Button(self.master, text='Destination File', width=12, height=1, command=fta.Browse2(self))
        self.btnBrowse2.grid(row=2, column=0, padx=(30,0), pady=(10,0), sticky=SE)
        self.btnCheckFile = tk.Button(self.master, text='File Check', width=12, height=2, command=fta.sortFile(self))
        self.btnCheckFile.grid(row=3, column=0, padx=(30,0), pady=(10,0), sticky=SE)
        self.btnCloseProgram = tk.Button(self.master, text='Close Program', width=12, height=2, command=fta.cancel(self))
